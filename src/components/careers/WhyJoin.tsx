  ...
  const benefits = [
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#FF6B00]">
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold font-heading text-[#081C3A] leading-tight mb-6">
          ...
          <div className="w-full lg:w-7/12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {benefits.map((item, idx) => (
                ...
                >
                  <div className="w-16 h-16 rounded-xl bg-[#FF6B00]/10 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                    {item.icon}
                  </div>
                  <h4 className="text-xl font-bold text-[#081C3A] mb-3">{item.title}</h4>
