    ...
    <>
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-4xl font-bold text-[#0f172a] font-heading mb-6">OEM Manufacturing</h2>
            ...
            >
              <img src="https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?q=80&w=1200&auto=format&fit=crop" alt="OEM Manufacturing" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-[#F4F7FA] relative overflow-hidden">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <img src={rdImg} alt="R&D Lab" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
            </motion.div>
            <motion.div 
              initial={{ opacity: 0, x: 40 }}
              whileInView={{ opacity: 1, x: 0 }}
            ...
            >
              <h2 className="text-4xl font-bold text-[#0f172a] font-heading mb-6">Research & Innovation</h2>
              <div className="w-20 h-1 bg-[#D4AF37] mb-8"></div>
              <p className="text-lg text-[#64748b] leading-relaxed mb-6">
              ...
              <div className="grid grid-cols-2 gap-6 mt-8">
                <div className="bg-white p-6 rounded-2xl border border-[#E2E8F0] shadow-sm">
                  <h4 className="font-bold text-[#0f172a] mb-2 text-xl">Thermal Tech</h4>
                  <p className="text-sm text-gray-500">Advanced temperature regulating phase-change materials.</p>
                </div>
                <div className="bg-white p-6 rounded-2xl border border-[#E2E8F0] shadow-sm">
                  <h4 className="font-bold text-[#0f172a] mb-2 text-xl">Acoustic Dampening</h4>
      ...
      <section className="relative py-32 overflow-hidden flex items-center">
        <div className="absolute inset-0 z-0">
          <img src="https://images.unsplash.com/photo-1586528116311-ad8ed7c50800?q=80&w=2000&auto=format&fit=crop" alt="Infrastructure" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
