        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-32">
            ...
            >
              ...
              <h2 className="text-4xl md:text-5xl font-black text-[#0f172a] mb-8 leading-tight font-heading">
          ...
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-[#0f172a] font-heading mb-4">Core Values</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {values.map((val, idx) => (
              ...
              >
                <div className="w-16 h-16 mx-auto bg-[#EEF5FF] text-[#0f172a] rounded-full flex items-center justify-center mb-6">
                  {val.icon}
                </div>
                <h4 className="text-xl font-bold text-[#0f172a] mb-3">{val.title}</h4>
