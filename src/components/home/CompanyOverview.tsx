        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          >
            <div className="inline-block border border-[#081C3A]/20 rounded-full px-6 py-2 bg-white">
              <span className="text-[#0f172a] font-bold tracking-widest uppercase text-xs">Company Overview</span>
            </div>
            
            <h2 className="text-4xl md:text-5xl font-bold text-[#0f172a] font-heading leading-tight">
              Pioneering <span className="text-[#D4AF37]">Engineering Excellence</span> for the World
            </h2>
            ...
            <div className="pt-4">
              <Link to="/about" className="btn-primary w-full md:w-auto text-center text-sm tracking-wide">DISCOVER OUR LEGACY</Link>
            </div>
          </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {features.map((feat, idx) => (
                <div key={idx} className="bg-[#FFFFFF] p-8 rounded-2xl shadow-[0_10px_30px_-15px_rgba(8,28,58,0.1)] border border-[#E2E8F0] hover:-translate-y-2 hover:shadow-[0_15px_35px_-10px_rgba(8,28,58,0.15)] transition-all duration-300 group">
                  <div className="w-14 h-14 bg-[#EEF5FF] text-[#D4AF37] rounded-2xl flex items-center justify-center mb-6 group-hover:bg-[#D4AF37] group-hover:text-white transition-colors duration-300">
                    {feat.icon}
                  </div>
