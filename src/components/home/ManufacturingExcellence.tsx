  ...
  return (
    <section className="py-24 md:py-32 bg-[#F7F8FA] overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
        ...
        >
          <div className="absolute inset-0 bg-white shadow-sm rounded-2xl -z-10 transition-transform duration-500 translate-x-4 translate-y-4 group-hover:translate-x-6 group-hover:translate-y-6"></div>
          <div className="relative overflow-hidden rounded-2xl shadow-premium">
            ...
            <div className="absolute bottom-0 left-0 bg-white/95 backdrop-blur-sm p-6 md:p-8 rounded-tr-2xl border-r border-t border-white shadow-lg">
