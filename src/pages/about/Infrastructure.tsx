  ...
  return (
    <PageLayout>
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 w-full py-20">
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-[#0f172a] mb-6 font-heading">Smart Factory Integration</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <div key={i} className="group relative aspect-video bg-[#FFFFFF] rounded-2xl overflow-hidden border border-[#E2E8F0] cursor-pointer">
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity z-10 flex items-end p-6">
                <span className="text-[#0f172a] font-bold tracking-wide">Facility Area {i}</span>
              </div>
