    ...
    <PageLayout>
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 w-full py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold text-[#0f172a] mb-6 font-heading">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-[#FFFFFF] p-6 rounded-2xl border border-[#E2E8F0]">
                <div className="text-3xl font-bold text-[#D4AF37] mb-2">45+</div>
                <div className="text-sm text-[#64748b] font-semibold uppercase tracking-wider">Years Experience</div>
              </div>
              <div className="bg-[#FFFFFF] p-6 rounded-2xl border border-[#E2E8F0]">
                <div className="text-3xl font-bold text-[#D4AF37] mb-2">120+</div>
                <div className="text-sm text-[#64748b] font-semibold uppercase tracking-wider">Global Partners</div>
              </div>
            </div>
          </div>
